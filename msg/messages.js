...
/*if(LANGUEGE_OF_BLOCKS=="ENG" || LANGUEGE_OF_BLOCKS == undefined)
{
Blockly.Msg.MOTORS_ON_FOR_SECONDS = 'Motors on for %1 seconds';
Blockly.Msg.MOTORS_ON = 'Motors on';
Blockly.Msg.MOTORS_OFF = 'Motors off';
Blockly.Msg.SET_ROBOT_DIRECTION = 'Set robot direction to %1';
Blockly.Msg.DIRECTION_FORWARD = 'Forward';
Blockly.Msg.DIRECTION_BACKWARD = 'Backward';
Blockly.Msg.DIRECTION_LEFT = 'turn left';
Blockly.Msg.DIRECTION_RIGHT = 'turn right';
Blockly.Msg.SET_ROBOT_MOTORS_ON_FOR_STEPS = 'Motors on for %1 steps';
Blockly.Msg.ROBOT_RESET_TRIP_METERS = 'Reset trip meters';
Blockly.Msg.ROBOT_TURN_RIGHT = 'turn %1 %2 degrees';
Blockly.Msg.ROBOT_TURN_LEFT  = 'turn %1 %2 degrees';
Blockly.Msg.ROBOT_SET_MOTORS_POWER = 'set motors power %1 %';
 Blockly.Msg.ROBOT_SET_MOTORS_POWER_LEFT_RIGHT_SEPARATELY = 'set motors power L %1 R %2 %';
Blockly.Msg.ROBOT_SET_MOTORS_LEFT_RIGHT_POWER_AND_DIRECTION_SEPARATELY = 'L %1 R %2 set power L %3  R %4 %';
Blockly.Msg.ROBOT_GET_SENSOR_DATA = 'Robot %1';
...
Blockly.Msg.ROBOT_SENSOR_TRIP_METER_LEFT       =          'trip meter L';
Blockly.Msg.ROBOT_SENSOR_TRIP_METER_RIGHT      =          'trip meter R';
Blockly.Msg.ROBOT_RGB_RED                      =          'red';
Blockly.Msg.ROBOT_RGB_GREEN                    =          'green';
Blockly.Msg.ROBOT_RGB_BLUE                     =          'blue';
Blockly.Msg.ROBOT_GET_RGB_SENSOR_DATA = 'Robot Color Sensor RGB %1 %2';
Blockly.Msg.ROBOT_START_BUTTON_PRESSED = 'Robot start button pressed?';
Blockly.Msg.ROBOT_TURN_LED_ON = 'turn robot led in %1 on';
Blockly.Msg.ROBOT_TURN_LED_OFF = 'turn robot led in %1 off';
Blockly.Msg.ROBOT_CLAW_CLOSED = 'Claw closed %1 %';
Blockly.Msg.ROBOT_CLAW_OPEN_STATE =                               'Open';
Blockly.Msg.ROBOT_CLAW_HALF_OPEN_STATE =                          'Half-open';
Blockly.Msg.ROBOT_CLAW_CLOSED_STATE =                             'Closed';
...
Blockly.Msg.COPTER_FLY_UP  = "";
Blockly.Msg.COPTER_LAND    = "Land";
Blockly.Msg.COPTER_STATUS  = "Status";
Blockly.Msg.COPTER_FLY_DISTANCE = "Fly  %1 cm";
Blockly.Msg.COPTER_FLY_BACKWARD = "Fly backward %1 cm";
Blockly.Msg.COPTER_FLY_TIME =  "Fly %1 seconds";
Blockly.Msg.COPTER_FLY_FOR_TIME_WITH_SPEED = "Fly %1 seconds with  %2 x speed %3 y speed";
...
Blockly.Msg.COPTER_STOP = "Stop!";
Blockly.Msg.COPTER_DIRECTION_FORWARD = 'Forward';
Blockly.Msg.COPTER_DIRECTION_BACKWARD = 'Backward';
Blockly.Msg.COPTER_DIRECTION_LEFT = 'Left';
Blockly.Msg.COPTER_DIRECTION_RIGHT = 'Right';
} */
...
Blockly.Msg.ru.COPTER_YAW = "Угол поворота";
...
Blockly.Msg.ru.WAIT_UNTIL = "Ждать пока не %1";
Blockly.Msg.ru.REPEAT_UNTIL = "Повторять пока не %1";
